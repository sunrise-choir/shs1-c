...
static uint8_t zeros[SHS1_CLIENT_SIZE + SHS1_SERVER_SIZE] = {0};

// test data generated via https://gist.github.com/AljoschaMeyer/d8766ce2ee6bc8e1e20194567863f25c
static uint8_t app[crypto_auth_KEYBYTES] = {111,97,159,86,19,13,53,115,66,209,32,84,255,140,143,85,157,74,32,154,156,90,29,185,141,19,184,255,104,107,124,198};

static uint8_t client_pub[crypto_sign_PUBLICKEYBYTES] = {225,162,73,136,73,119,94,84,208,102,233,120,23,46,225,245,198,79,176,0,151,208,70,146,111,23,94,101,25,192,30,35};
static uint8_t client_sec[crypto_sign_SECRETKEYBYTES] = {243,168,6,50,44,78,192,183,210,241,189,36,183,154,132,119,115,84,47,151,32,32,26,237,64,180,69,20,95,133,92,176,225,162,73,136,73,119,94,84,208,102,233,120,23,46,225,245,198,79,176,0,151,208,70,146,111,23,94,101,25,192,30,35};
static uint8_t client_eph_pub[crypto_box_PUBLICKEYBYTES] = {79,79,77,238,254,215,129,197,235,41,185,208,47,32,146,37,255,237,208,215,182,92,201,106,85,86,157,41,53,165,177,32};
static uint8_t client_eph_sec[crypto_box_SECRETKEYBYTES] = {80,169,55,157,134,142,219,152,125,240,174,209,225,109,46,188,97,224,193,187,198,58,226,193,24,235,213,214,49,55,213,104};

static uint8_t server_pub[crypto_sign_PUBLICKEYBYTES] = {42,190,113,153,16,248,187,195,163,201,187,204,86,238,66,151,52,115,160,4,244,1,12,76,170,129,66,12,202,54,1,70};
static uint8_t server_sec[crypto_sign_SECRETKEYBYTES] = {118,98,17,77,86,116,58,146,99,84,198,164,35,220,73,213,246,224,242,230,175,116,71,218,56,37,212,66,163,14,74,209,42,190,113,153,16,248,187,195,163,201,187,204,86,238,66,151,52,115,160,4,244,1,12,76,170,129,66,12,202,54,1,70};
static uint8_t server_eph_pub[crypto_box_PUBLICKEYBYTES] = {166,12,63,218,235,136,61,99,232,142,165,147,88,93,79,177,23,148,129,57,179,24,192,174,90,62,40,83,51,9,97,82};
static uint8_t server_eph_sec[crypto_box_SECRETKEYBYTES] = {176,248,210,185,226,76,162,153,239,144,57,206,218,97,2,215,155,5,223,189,22,28,137,85,228,233,93,79,217,203,63,125};
...
static uint8_t expected_client_decryption_key[crypto_secretbox_KEYBYTES] = {125,136,153,7,109,241,239,84,228,176,141,23,58,129,90,228,188,93,191,224,209,67,147,187,45,204,178,17,77,225,117,98};
static uint8_t expected_client_decryption_nonce[crypto_secretbox_NONCEBYTES] = {211,6,20,155,178,209,30,107,1,3,140,242,73,101,116,234,249,127,131,227,142,66,240,195};
static uint8_t expected_server_encryption_key[crypto_secretbox_KEYBYTES] = {125,136,153,7,109,241,239,84,228,176,141,23,58,129,90,228,188,93,191,224,209,67,147,187,45,204,178,17,77,225,117,98};
static uint8_t expected_server_encryption_nonce[crypto_secretbox_NONCEBYTES] = {211,6,20,155,178,209,30,107,1,3,140,242,73,101,116,234,249,127,131,227,142,66,240,195};
static uint8_t expected_server_decryption_key[crypto_secretbox_KEYBYTES] = {162,29,153,150,123,225,10,173,175,201,160,34,190,179,158,14,176,105,232,238,97,66,133,194,250,148,199,7,34,157,174,24};
static uint8_t expected_server_decryption_nonce[crypto_secretbox_NONCEBYTES] = {44,140,79,227,23,153,202,203,81,40,114,59,56,167,63,166,201,9,50,152,0,255,226,147};
...
{
  uint8_t invalid_client_challenge[SHS1_CLIENT_CHALLENGE_BYTES];
...
{
  uint8_t invalid_server_challenge[SHS1_CLIENT_CHALLENGE_BYTES];
...
void test_invalid_client_auth()
{
  ...
  uint8_t invalid_client_auth[SHS1_CLIENT_AUTH_BYTES];
